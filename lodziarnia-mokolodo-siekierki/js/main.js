document.addEventListener('DOMContentLoaded', function () {
  ...
  // Event inquiry form validation (contact page)
  ...
  if (form) {
    form.addEventListener('submit', function (e) {
      ...
      if (!fullName) { setError('fullName', true); valid = false; } else { setError('fullName', false); }
      if (!email || !emailPattern.test(email)) { setError('email', true); valid = false; } else { setError('email', false); }
      if (!guests) { setError('guests', true); valid = false; } else { setError('guests', false); }
